  ...
  <div class="Additional">
    ...
    <v-card>
        ...
        <template v-slot:default height="250">
          ...
          <tbody>
            <tr v-for="additional in additionals" :key="additional.id">
              ...
              <td class="text-center">
                <v-btn small color="error" class="mt-6" @click=remove(additional)>
                  Delete
                </v-btn>
      ...
      <b-modal id="modal-additional" title="Additional">
        ...
        <v-text-field v-model="additional.name" outlined label="Additional amount name" placeholder="Name 1"
